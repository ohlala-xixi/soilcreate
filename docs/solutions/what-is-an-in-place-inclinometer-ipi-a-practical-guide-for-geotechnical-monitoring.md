...
description: "Practical guide to in-place inclinometers for automated sensor-chain deformation monitoring in excavations, slopes, retaining walls, tunnels, and dams."
answerFirst: "An in-place inclinometer is a permanently installed sensor chain or sensor group that measures lateral ground or structural displacement along installed sensor positions. It is commonly used for automated monitoring of deep excavations, slopes, retaining walls, tunnels, dams, and other high-risk geotechnical sites."
...
takeaways:
  - "An in-place inclinometer stays installed and records movement through a sensor chain or sensor group automatically."
  - "It fits projects where frequent readings or limited access make manual surveys insufficient."
  - "Sensor spacing and target depth should follow the expected deformation mechanism."
  - "Logger, power, communication, and cable protection are part of the monitoring reliability."
  - "SoilCreate IPI systems can support automated borehole deformation monitoring workflows."
relatedProducts:
...
faqs:
  - question: "What is an in-place inclinometer or IPI?"
    answer: "It is an installed inclinometer sensor chain or sensor group that records lateral displacement automatically through a data logger or monitoring platform."
  ...
  - question: "How can SoilCreate fit into this workflow?"
    answer: "SoilCreate in-place inclinometer options can support long-term monitoring where a fixed sensor string is more practical than repeated manual readings."
---
## Definition

An **in-place inclinometer (IPI)** is an installed sensor chain or sensor group that measures lateral displacement automatically along its installed sensor positions. It is used for frequent borehole deformation monitoring where manual readings are too slow, unsafe, or difficult to maintain.
...
### 1. What is an in-place inclinometer or IPI?

It is an installed inclinometer sensor chain or sensor group that records lateral displacement automatically through a data logger or monitoring platform.
...
An in-place inclinometer is best understood as an automated borehole deformation workflow, not just a single sensor. Sensor chain layout, target movement zones, cable protection, logger setup, power, communication, and baseline quality all affect the result.

SoilCreate IPI systems can support frequent deformation monitoring in critical boreholes, while project teams should confirm the layout and response rules through engineering review.
